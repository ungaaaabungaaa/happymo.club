    ...
    <div className="custom-screen">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-lg text-white font-bold">
          Join instant to our Copy Trading Platform. Track your Profits Daily,
          Win Daily <span></span>& make informed decisions -
          <span className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 mt-2 ">
            {" "}
            40x Challenge.
          </span>
        </p>
